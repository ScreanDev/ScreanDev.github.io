---
title: "FrostHorn"
description: "Un jeu d'aventure post-apocalyptique en 2D au cœur d'une histoire dans laquelle le joueur doit explorer et innover..."
banner: "projet-frosthorn.png"
modalDesc: "Le projet de jeu vidéo (et au sens large informatique) le plus ambitieux que je réalise."
modalBanner: "projet-frosthorn.png"
tags:
  - name: "En cours !"
    class: "red-tag"
  - name: "Jeu"
...
Au stade actuel des choses, nous sommes déjà détenteurs d'un site web statique que nous développons en parallèle : https://wiki.u-night.org, et qui contiendra à l'avenir toute la documentation utile au jeu (en matière d'histoire, d'objets, de fonctionnalités etc.). Pour ce faire, nous utilisons l'outil <a href="https://docusaurus.io" target="_blank">Docusaurus</a>, ainsi que le langage Node.Js. Le lien du projet GitHub et celui du site vous sont fournis en bas de cette page !</p>

![Logo du jeu](../../../../../assets/frosthorn-project-horn.png)
![Réunion](../../../../../assets/frosthorn-project-meeting.png)
...
![Logo U-Night complet](../../../../../assets/frosthorn-project-unight-icon-full.png)
![Logo U-Night](../../../../../assets/frosthorn-project-unight-icon.png)
